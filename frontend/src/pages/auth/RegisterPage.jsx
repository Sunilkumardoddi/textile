...
const RegisterPage = () => {
    ...
    const roles = [
        { value: 'manufacturer', label: 'Manufacturer', description: 'Create batches, manage production, receive POs' },
        { value: 'brand', label: 'Brand', description: 'Track suppliers, request audits, create POs' },
